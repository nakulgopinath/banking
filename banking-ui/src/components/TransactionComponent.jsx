            ...
            <React.Fragment>
                <div className="card text-center">
                    <div className="card-header">
                        <h1>Fund Transfer</h1>
                        <hr></hr>
                        <h4>Account No.</h4><input type="text" disabled value={this.state.transaction.senderAccNo} name="senderAccNo"></input><br></br>
                        <h4>Account Holder's Name</h4><input type="text" disabled value={this.state.senderName} name="senderName"></input><br></br>
                        <h4>Available Balance</h4><input type="number" disabled value={this.state.senderAvailableBalance} name="senderAvailableBalance"></input><br></br>
